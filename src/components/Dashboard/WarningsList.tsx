...
export default function WarningsList({ warnings }: WarningsListProps) {
  ...
  const getWarningColor = (type: string) => {
    switch (type) {
      case 'critical': return 'text-red-600 bg-red-50 border-red-200 dark:text-red-200 dark:bg-red-900/30 dark:border-red-600';
      case 'warning': return 'text-yellow-600 bg-yellow-50 border-yellow-200 dark:text-yellow-200 dark:bg-yellow-900/30 dark:border-yellow-600';
      default: return 'text-blue-600 bg-blue-50 border-blue-200 dark:text-blue-200 dark:bg-blue-900/30 dark:border-blue-600';
    }
  };
    ...
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-md p-6">
      ...
      {warnings.length === 0 ? (
        <div className="text-center py-8">
          <div className="text-green-600 dark:text-green-400 bg-green-50 dark:bg-green-900/30 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
            ...
            return (
              ...
              >
                ...
                <div className="flex-1">
                  <p className="font-medium opacity-95">{warning.category}</p>
                  <p className="text-sm opacity-85">{warning.message}</p>
